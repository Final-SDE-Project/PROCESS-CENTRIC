 ...
 * 
 */
@WebServiceClient(name = "StorageService", targetNamespace = "http://ws.controller_storage.ehealth/", wsdlLocation = "https://sde-storage.herokuapp.com/ws/storage?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STORAGESERVICE_QNAME = new QName("http://ws.controller_storage.ehealth/", "StorageService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sde-storage.herokuapp.com/ws/storage?wsdl");
     ...
     * 
     * @return
     *     returns ServiceStorage
     */
    @WebEndpoint(name = "ServiceStorageImplPort")
    public ServiceStorage getServiceStorageImplPort() {
        return super.getPort(new QName("http://ws.controller_storage.ehealth/", "ServiceStorageImplPort"), ServiceStorage.class);
    }
     ...
     */
    @WebEndpoint(name = "ServiceStorageImplPort")
    public ServiceStorage getServiceStorageImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.controller_storage.ehealth/", "ServiceStorageImplPort"), ServiceStorage.class, features);
    }
